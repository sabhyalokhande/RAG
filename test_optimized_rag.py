#!/usr/bin/env python3
"""
Test optimized RAG system with batching and fallback
"""
import requests
import json
import time
...
def test_optimized_rag():
    """Test the optimized RAG system with professional optimizations."""
    print("🚀 Testing Optimized RAG System")
    print("=" * 50)
    
    # Test data with fewer questions to test batching
    test_data = {
